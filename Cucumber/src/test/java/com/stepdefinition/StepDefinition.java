...
public class StepDefinition {
	...
	public void i_enter_the_Valid_FirstName_LastName_Billing_Address_CreditCardNo_and_Select_CreditCardType_Expiry_Month_Expiry_Year_and_Enter_Valid_Cvv() {
	...
	@Then("I want to select the valid Details of {string},{string},{string},{string} and  Enter the CheckIn,CheckOut Dates and Select the valid {string} and {string}")
	public void i_want_to_select_the_valid_Details_of_and_Enter_the_CheckIn_CheckOut_Dates_and_Select_the_valid_and(
			String string, String string2, String string3, String string4, String string5, String string6) {
		WebElement ddLocation = driver.findElement(By.name("location"));
		new Select(ddLocation).selectByVisibleText(string);
		new Select(driver.findElement(By.id("hotels"))).selectByVisibleText(string2);
		WebElement ddRoomType = driver.findElement(By.name("room_type"));
		new Select(ddRoomType).selectByVisibleText(string3);
		WebElement ddRoomNos = driver.findElement(By.name("room_nos"));
		new Select(ddRoomNos).selectByVisibleText(string4);
		WebElement ddAdult = driver.findElement(By.name("adult_room"));
		new Select(ddAdult).selectByVisibleText(string5);
		WebElement ddChild = driver.findElement(By.name("child_room"));
		new Select(ddChild).selectByVisibleText(string6);
	}

	@When("I enter the Valid {string},{string},{string},{string} and Select {string},{string},{string} and {string}")
	public void i_enter_the_Valid_and_Select_and(String string, String string2, String string3, String string4,
		...
		new Select(driver.findElement(By.id("cc_type"))).selectByVisibleText(string5);

		new Select(driver.findElement(By.id("cc_exp_month"))).selectByVisibleText(string6);

		new Select(driver.findElement(By.id("cc_exp_year"))).selectByVisibleText(string7);
